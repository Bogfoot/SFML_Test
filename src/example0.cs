...
//
//*****************************************************************************
// $Id: example0.cs,v 1.1 2020/11/25 14:55:45 trurl Exp $
    ...
    class Example
    {
        ...
        unsafe static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    Int32 updates  = 0;
                    IntPtr dataArr = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(Int32))*59);
                    ...
                    if (updates > 0)
                    {
                        Console.WriteLine("0:{0} 1:{1} 2:{2} 3:{3}  1-2:{4} 1-3:{5} 1-2-3:{6}",
                                dPtr[0], dPtr[1], dPtr[2], dPtr[3], dPtr[33], dPtr[34], dPtr[43]);
                    }
